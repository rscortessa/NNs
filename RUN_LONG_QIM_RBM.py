...
from Methods.class_WF import rotated_sigmax, rotated_sigmaz,isigmay,rotated_IsingModel,rotated_LONGIsingModel
...
for tt in range(NMEAN):
    for ii in range(len(angle)):
        ...
        H=rotated_LONGIsingModel(angle[ii],G*DG,L,hi)
