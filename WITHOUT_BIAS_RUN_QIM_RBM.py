...
if modelo=="RBM_COMPLEX":
    model=nk.models.RBM(alpha=NN,use_hidden_bias=False,use_visible_bias=False,param_dtype=complex)
    sr = nk.optimizer.SR(diag_shift=0.1, holomorphic=True)
elif modelo=="RBM_REAL":
    model=nk.models.RBM(alpha=NN,use_hidden_bias=False,use_visible_bias=False)
