...
MASTER_DIR="FULL_STATE_RUN_QIM_"+modelo+"NN"+str(NN)+"L"+str(L)+"G"+str(G)+"NA"+str(Nangle)+"NSPCA"+str(NSPCA)+"SHIFT"+str(diag_shift)+"HPAR"+str(round(hpar,2))
...
for tt in range(NMEAN):
    for ii in range(len(angle)):
        ...
        H = rotated_BROKEN_Z2IsingModel(angle[ii],G*DG,L,hi,hpar)
